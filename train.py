	...
	for epoch in range(start_epoch, args.end_epoch):
		...
		for idx, data in tqdm(enumerate(train_dataloader)):
			...
			if val_ssim < args.fi_threshold:
				optimizer_encoder.zero_grad()
				decoder_out, decoder_loss = backward_reconstruction_loss(decoder, encoder, encoder_outs, cl_img,
				...
				optimizer_encoder.zero_grad()
				decoder_out, decoder_loss = backward_reconstruction_loss(decoder, encoder, encoder_outs, cl_img, criterion_MSE, optimizer_decoder,
